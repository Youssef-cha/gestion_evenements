      ...
      >
        <div className="lg:w-1/2 w-full p-6 md:p-10">
          <div className="mb-8">
            ...
            <p className="text-neutral-500 dark:text-neutral-400 text-center">Sign in to access your account</p>
          </div>
        ...
        <div className="lg:w-1/2 relative hidden lg:block">
          <div className="absolute inset-0 bg-gradient-to-br from-black/70 to-neutral-800/40 z-10 flex flex-col justify-center items-center p-10 text-white">
            ...
            >
              ...
              <p className="text-neutral-200 mb-6">Sign in to continue your journey with us</p>
